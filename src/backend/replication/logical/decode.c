 ...
 *		purpose of changeset generation by passing information to the
 ...
 *      specific record's struct is used to pass data along, but those contain
 *      just the right amount of data. There isn't and shouldn't be much
 *      intelligence about the contents of records except turning them into a
 *      more usable format.
 *
