...
-- ----------------------------------------------------------------
-- IRR  = will be blocked by SET ROLE x IRREVOCABLE (the v1 patch)
-- COOK = will be blocked by SET ROLE x WITH COOKIE (v1 patch, if
--        cookie not exposed)
-- OTHER = requires hardening orthogonal to the v1 patch (search_path
--         discipline, SECDEF audit, etc.); listed here because the
--         shared problem is "SET ROLE is not a sound isolation
--         boundary"
--
--   A.  Direct restoration class       — IRR, COOK
--   B.  GUC rollback class             — IRR, COOK
--   C.  search_path hijack             — IRR helps reduce damage
...
--                                         attacker-controlled
--                                         functions.)
--   E.  SECURITY DEFINER lent back     — IRR if the SECDEF body does
--                                         a SET ROLE the caller's
--                                         lock should clip
--   F.  Connection-state escape        — IRR
...
-- ============================================================
-- A.  Direct privilege restoration  [IRR]
-- ============================================================
...
-- ============================================================
-- C.  search_path hijack  [IRR partially / OTHER]
-- ============================================================
...
-- ============================================================
-- E.  SECURITY DEFINER lent back to lowered context  [IRR + OTHER]
-- ============================================================
